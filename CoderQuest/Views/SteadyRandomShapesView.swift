...
struct SteadyRandomShapesView: View {
    ...
    let shapes = [
            AnyView(Circle()
                        ...
                        .shadow(radius: 10)
                        .overlay(
                            Text(shapesField.randomElement()!)
                                .font(.system(size: 30))
                                .fontWeight(.bold)
    ...
    let paddingBetweenCircles: CGFloat = 55  // Space between the layers of circles
    let shapeSize: CGFloat = 70  // Fixed size of each shape
